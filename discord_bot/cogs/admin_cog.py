...
class AdminCog(commands.Cog):
    def __init__(self, bot: commands.Bot):
        self.bot = bot
        self.dkp_group = app_commands.Group(name="dkp", description="Admin commands for the DKP system.")

    async def show_admin_panel(self, interaction: discord.Interaction):
        # This could be a view with more buttons in a real scenario
        await self.status_cmd.callback(self, interaction)
